package c5_initialization;

import c6_access.*;

public class Tasks {

   MyClass myClass = new MyClass(); // 1 - c6_access
...
// 22 - enum with switch
    ...
    public static void main(String[] args) {
        ...
        Tasks
                u = new Tasks(Money.USA),
                r = new Tasks(Money.RUB),
                e = new Tasks(Money.EUR),
                j = new Tasks(Money.JPY);
